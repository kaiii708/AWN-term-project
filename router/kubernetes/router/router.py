...
# Create ARP table.
arp_table_socket = {CLIENT_1_IP: client1,
                    CLIENT_2_IP: client2, CLIENT_3_IP: client3}
arp_table_mac = {CLIENT_1_IP: CLIENT_1_MAC,
                 CLIENT_2_IP: CLIENT_2_MAC, CLIENT_3_IP: CLIENT_3_MAC}
